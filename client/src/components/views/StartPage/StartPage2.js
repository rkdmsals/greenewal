            ...
            <div className="GrnPage_container">
                ...
                <div className="GrnBanner">
                    <Slider {...settings}>
                        ...
                        <div>
                            <img className="GrnBanE" id="GrnBanE_5" src="/img/StartPage/banner5.jpg" alt="banner5" onClick={() => redirectToExternalLink('https://map.naver.com/p/entry/place/1125845933?lng=126.9449089&lat=37.559425&placePath=%2Fhome&entry=plt&c=15.00,0,0,0,dh')}></img>
                        </div>
                    </Slider>
                </div>
