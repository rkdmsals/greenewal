    ...
    return (<div className="BoothInfo">
        ...
        <div className="AllBooths">
            ...
            <div className="EachBooth">
                <img className="BoothImg" src="/img/Booth/cloberVec.svg" alt="리뉴얼부스 이미지(로고)"></img>
            ...
            <div className="EachBooth">
                <img className="BoothImg" src="/img/photo/greenpt.png" alt="네컷사진-그린네컷 이미지"></img>
                <div className="EachBoothInfo">
            ...
            <div className="EachBooth">
                <img className="BoothImg" src="/img/menu/bp.png" alt="먹거리 부스-핫초코"></img>
                <div className="EachBoothInfo">
