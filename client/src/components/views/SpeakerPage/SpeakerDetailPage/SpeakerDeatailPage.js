            ...
            <div className="speakerDetailPage_container">
                ...
                <div className="speakerDetailInfo" id="speakerInfo_1">
                    <div className="speakerDetailInfo_content">
                        <div className="speakerInfo_detail_name">전효진<div className="speakerInfo_job">변호사</div></div>
                ...
                <div className="speakerDetailInfo" >
                    ...
                    <div className="speakerDetailInfo_content">
                        <div id="speakerInfo_2">
                            <div className="speakerInfo_detail_name speakerInfo_detail_name_2">이주미<div className="speakerInfo_job">강사·변호사</div></div>
                        ...
                        <div className="speaker_detail_svg2"><img className="speaker_detail_img2" src="/img/SpeakerPage/speaker2.png" alt="speaker2" /></div>
                    </div>
                </div>
